...
public class ParametersGenerator {
    public static void main(String[] args) {
        ...
        N.forEach(particles -> noise.forEach(n -> {
            String staticFilename = String.format(Locale.ROOT ,"parameters/static_N_%d_L_%d_n_%.1f%s", particles, L, n, extension);
            String dynamicFilename = String.format(Locale.ROOT, "parameters/dynamic_N_%d_L_%d_n_%.1f%s", particles, L, n, extension);
            Particle.n = n;
